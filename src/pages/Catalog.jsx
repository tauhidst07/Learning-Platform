...
useEffect(() => {
  ...
  return (
    <div>
      ...
      <div className='mx-auto flex min-h-[260px]  flex-col justify-center gap-4  lg:w-11/12 lg:max-w-maxContent'>
      ...
      <div className=' mx-auto box-content w-full max-w-maxContentTab px-2 py-12 lg:max-w-maxContent'>
        <h2 className='Courses to get you started text-richblack-200'>
